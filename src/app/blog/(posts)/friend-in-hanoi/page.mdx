export const metadata = {
  category: 'Travel',
  date: '2024-03-27',
  images: ['train-lights.png', 'bun-cha-me.png', 'market.jpeg', 'bun-xeo.png'],
  title: 'Meeting a friend in Hanoi',
};

Next stop is Hanoi! I have a flight from Danang to Hanoi, where I have plans to meet a friend I met 10 years ago, Jan. We hadn't seen each other in 5 years so I was looking forward to catching up. But first when arriving in Hanoi, I had to eat. I decided to get a delicous Bun Cha, famous in Hanoi.
...
Jan is a great photographer and got some photos that portrait the busy city of Hanoi.
...
The next day, we went to the Ho Chi Minh Mossoleum, where Ho Chi Minh's body is preserved (against his wishes).

![Ho Chi Minh Mossoleum](/friend-in-hanoi/mossoleum.png 'Ho Chi Minh Mossoleum')
